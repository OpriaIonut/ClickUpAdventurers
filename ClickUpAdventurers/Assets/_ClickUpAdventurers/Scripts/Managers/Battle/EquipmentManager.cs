...
namespace ClickUpAdventurers
{
    public class EquipmentManager : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            EquipmentRetainer equipRetainer = EquipmentRetainer.instance;

            ItemScriptableObj item1 = equipRetainer.GetEquippedItem(PlayerTypes.Archer, ItemEffect.Damage);
            ItemScriptableObj item2 = equipRetainer.GetEquippedItem(PlayerTypes.Archer, ItemEffect.Cooldown);
            ItemScriptableObj item3 = equipRetainer.GetEquippedItem(PlayerTypes.Archer, ItemEffect.AccuracyTime);
            ...
            item1 = equipRetainer.GetEquippedItem(PlayerTypes.Mage, ItemEffect.Size);
            item2 = equipRetainer.GetEquippedItem(PlayerTypes.Mage, ItemEffect.Cooldown);
            item3 = equipRetainer.GetEquippedItem(PlayerTypes.Mage, ItemEffect.Damage);
            ...
            item1 = equipRetainer.GetEquippedItem(PlayerTypes.Looter, ItemEffect.Size);
            item2 = equipRetainer.GetEquippedItem(PlayerTypes.Looter, ItemEffect.Health);
            item3 = equipRetainer.GetEquippedItem(PlayerTypes.Looter, ItemEffect.Cooldown);
            ...
            item1 = equipRetainer.GetEquippedItem(PlayerTypes.Warrior, ItemEffect.Cooldown);
            item2 = equipRetainer.GetEquippedItem(PlayerTypes.Warrior, ItemEffect.Health);
            item3 = equipRetainer.GetEquippedItem(PlayerTypes.Warrior, ItemEffect.HealthRecovery);

            if (item1.multiplier == 0)
                warrior1.attackCooldown = 0;
            else
                warrior1.attackCooldown = warrior1.attackCooldown / item1.multiplier;
            warrior1.maxHealth = dataRetainer.warriorMaxHP;
            ...
            warrior2.maxHealth = dataRetainer.warriorMaxHP;
